            ...
            <form method="POST" action="" id="assessment-form">
                ...
                <div class="forms-data-collection">
                    ...
                    <div class="form-step active" id="step-1"
                        data-title="Foundation of Growth"
                        ...
                        <div class="buttons">
                            ...
                            <button type="button" class="btn next-btn" id="basic-info-next-btn">Next <i class="icon icon-arrow-right"></i></button>
                        </div>
                    </div>

                    <div class="form-step" id="step-2"
                        data-title="What Sparks Your Curiosity?"
                        ...
                        <div class="interest-selection">
                            <div class="interest-options">
                                <div class="interest-card">
                                    ...
                                    <p>Mastering languages like Python, Java, and C++ to build robust software architectures.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Designing immersive worlds and mechanics using Unity, Unreal Engine, and C#.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Creating seamless user experiences for iOS and Android with Swift and Kotlin.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Protecting systems, networks, and programs from digital attacks and ensuring data integrity.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Designing and maintaining computer networks to ensure efficient data communication.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Integrating mechanical engineering with smart software to automate complex tasks.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Interpreting complex data sets to drive business decisions and uncover valuable insights.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Creating intuitive and engaging user experiences through thoughtful design principles.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                    ...
                                    <p>Capturing compelling visual stories through expert cinematography and editing.</p>
                                </div>
                                <div class="interest-card">
                                    <div class="icon-container">
                                ...
                                <div class="interest-card">
                                    ...
                                    <p>Understanding and applying AI and ML techniques to solve complex problems.</p>
                                </div>
                        ...
                        <div class="buttons">
                            ...
                            <button type="button" class="btn next-btn" id="interest-next-btn">Next <i class="icon icon-arrow-right"></i></button>
                        </div>
                    </div>


                    <div class="form-step" id="diagnostic-skill-test"
                        data-title="Rate your self"
                        ...
                        <div>
                            ...
                            <div class="buttons">
                                <button type="button" class="btn prev-btn"><i class="icon icon-arrow-left"></i> Previous</button>
                                <button type="button" class="btn next-btn" id="skill-next-btn">Next <i class="icon icon-arrow-right"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="info-cards">
                            <div class="card">
                                ...
                                <p>Research shows that self-reflection activates neural pathways associated with meta- cognition, allowing for more accurate skill alignment in vocational transitions.</p>
                            </div>
                            <div class="card">
                                <i class="icon icon-book"></i>
                                <h3>How Your Responses Are Used</h3>
                                <p>Your self-assessment is combined with test performance and interest data. These inputs are processed using a machine learning model to generate career track recommendations</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-step" id="diagnostic-mini-test"
                        data-title="Mini Test"
